...
import com.wyd.connect.netty.common.NettyConstants;
...
public class StringClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        new Thread(() -> {
            ...
            String content = userName + "," + NettyConstants.MESSAGE_TYPE_START;
                    ...
                    while (true) {
                        ...
                        if (innerInterval >= interval) {
                            ...
                            if (inthhmm >= beginTime && inthhmm <= endTime) {
                                // 该发送通知了
                                String taskContent = userName + "," + NettyConstants.MESSAGE_TYPE_TASK;
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        System.out.println("netty连接异常：" + cause.getMessage());
