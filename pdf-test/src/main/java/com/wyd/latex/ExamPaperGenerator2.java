...
public class ExamPaperGenerator2 {
    ...
    private static class LatexSegment {
        final String code;
        LatexSegment(String code) {
            this.code = code;
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        String output = "C:\\Users\\11748\\Documents\\3333.pdf";
    ...
    private static void drawSegment(PageContext ctx, String text, float fontSize, float lineHeight) throws IOException {
        ...
        while (matcher.find()) {
            ...
            float ph = img.getHeight() * 0.1f;
            float th = Math.min(Math.max(ph, fontSize), fontSize * 2.5f);
    ...
    private static PDType0Font loadChineseFont(PDDocument doc) throws IOException {
        InputStream is = ExamPaperGenerator2.class.getResourceAsStream("/fonts/simhei.ttf");
